...
public class Student extends User {
    ...
    public Student(String id, String name, String dob, String number, String address, String email, String password) {
        super(name, id, dob, number, address, password, email, "student");
    }
    ...
    public static Student fromTextLine(String line) {
        ...
        if (!"student".equals(role)) {
            throw new IllegalArgumentException("Invalid role for student: " + role);
        }
        return new Student(id, name, dob, number, address, email, password);
    }
